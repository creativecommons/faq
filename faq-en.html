...
<title>About The Licenses - Creative Commons</title>
...
Toggle TOC
      ...
      <li><a href="#notes">Notes</a></li>
        ...
        <p>__NOTOC__ These FAQs are designed to provide a better understanding of Creative Commons, our licenses, and our other legal and technical tools. They provide basic information, sometimes about fairly complex topics, and will often link to more detailed information.</p>
<ul>
<li>Other CC FAQs: <a href="CC0_FAQ" title="wikilink">CC0 Public Domain Dedication</a> and <a href="PDM_FAQ" title="wikilink">Public Domain Mark</a>.</li>
...
<li>Information about the licenses is primarily made with reference to the 4.0 suite, but earlier <a href="License_Versions" title="wikilink">license versions</a> are mentioned where they differ.</li>
<li>Have a question that isn't answered here? Contact info@creativecommons.org.</li>
</ul>
<h2 id="about-cc">About CC</h2>
...
<h3 id="what-is-creative-commons-and-what-do-you-do">What is Creative Commons and what do you do?</h3>
<p>Creative Commons is a global nonprofit organization that enables sharing and reuse of creativity and knowledge through the provision of free legal tools. Our legal tools help those who want to encourage reuse of their works by offering them for use under generous, standardized terms; those who want to make creative uses of works; and those who want to benefit from this symbiosis. Our vision is to help others realize the full potential of the internet. CC has affiliates <a href="http://creativecommons.org/international/">all over the world</a> who help ensure our licenses work internationally and who raise awareness of our work.</p>
<p>Although Creative Commons is best known for its licenses, our work extends beyond just providing copyright licenses. CC offers other legal and technical tools that also facilitate sharing and discovery of creative works, such as <a href="http://creativecommons.org/choose/zero/">CC0</a>, a public domain dedication for rights holders who wish to put their work into the public domain before the expiration of copyright, and the <a href="http://creativecommons.org/publicdomain/mark/1.0">Public Domain Mark</a>, a tool for marking a work that is in the worldwide public domain. <a href="#Technical_Questions_2" title="wikilink">Creative Commons licenses and tools were designed specifically to work with the web</a>, which makes content that is offered under their terms easy to search for, discover, and use.</p>
<p>For more information about CC, our <a href="http://creativecommons.org">main website</a> contains in-depth information about <a href="http://creativecommons.org/about/">the organization</a>, its <a href="http://creativecommons.org/staff/">staff and board of directors</a>, its <a href="http://creativecommons.org/about/history">history</a>, and its <a href="https://support.creativecommons.org/supporters">supporters</a>. You can also read <a href="http://wiki.creativecommons.org/Case_Studies">CC case studies</a> to learn about some of the inspiring ways CC licenses and tools have been used to share works and support innovative business models. You can find regularly updated information about CC by visiting the <a href="http://creativecommons.org/weblog">blog</a>.</p>
<h3 id="is-creative-commons-against-copyright">Is Creative Commons against copyright?</h3>
<p>Absolutely not. CC has <a href="http://creativecommons.org/weblog/entry/22643">responded to claims to the contrary</a>. CC licenses are copyright licenses, and depend on the existence of copyright to work. CC licenses are legal tools that creators and other rights holders can use to offer certain usage rights to the public, while reserving other rights. Those who want to make their work available to the public for limited kinds of uses while preserving their copyright may want to consider using CC licenses. Others who want to reserve all of their rights under copyright law should not use CC licenses.</p>
<p>That said, Creative Commons recognizes the need for change in copyright law, and many members of the Creative Commons community are active participants in the copyright reform movement. For more information, see our <a href="http://creativecommons.org/about/reform">statement in support of copyright reform</a>.</p>
<h3 id="what-does-some-rights-reserved-mean">What does &quot;Some Rights Reserved&quot; mean?</h3>
<p><a href="Frequently_Asked_Questions#What_is_copyright_and_why_does_it_matter.3F" title="wikilink">Copyright</a> grants to creators a bundle of exclusive rights over their creative works, which generally include, at a minimum, the right to reproduce, distribute, display, and make adaptations. The phrase &quot;All Rights Reserved&quot; is often used by owners to indicate that they reserve all of the rights granted to them under the law. When copyright expires, the work enters the <a href="#What_is_the_public_domain.3F" title="wikilink">public domain</a>, and the rights holder can no longer stop others from engaging in those activities under copyright, with the exception of moral rights reserved to creators in some jurisdictions. Creative Commons licenses offer creators a spectrum of choices between retaining all rights and relinquishing all rights (public domain), an approach we call &quot;Some Rights Reserved.&quot;</p>
...
<h3 id="can-creative-commons-give-legal-advice-about-its-licenses-or-other-tools-or-help-with-cc-license-enforcement">Can Creative Commons give legal advice about its licenses or other tools, or help with CC license enforcement?</h3>
...
<ul>
<li><a href="Marking/Creators" title="wikilink">Marking practices for creators</a></li>
<li><a href="Marking/Users" title="wikilink">Marking practices for reusers</a></li>
...
<li><a href="PDM_FAQ" title="wikilink">Public domain mark FAQ</a></li>
<li><a href="CC0_FAQ" title="wikilink">CC0 FAQ</a></li>
</ul>
...
<p>If you're looking for legal advice about using CC licenses and other tools, we recommend contacting the <a href="CC%20Affiliate%20Network" title="wikilink">Creative Commons affiliate in your jurisdiction</a>. CC affiliates are highly connected to the communities of copyright lawyers in their countries. We also offer a <a href="CC_Friendly_Lawyers" title="wikilink">list of lawyers and organizations</a> who have identified themselves as willing to provide information to others about CC licensing issues. However, please note that CC does not provide referral services, and does not endorse or recommend any person on that list.</p>
...
<h3 id="does-creative-commons-collect-or-track-material-licensed-under-a-cc-license">Does Creative Commons collect or track material licensed under a CC license?</h3>
...
<h3 id="may-i-use-the-creative-commons-logo-and-buttons">May I use the Creative Commons logo and buttons?</h3>
<p>You may <a href="http://creativecommons.org/about/downloads">download high resolution versions</a> of the Creative Commons logos and use them in connection with your work or your website, provided you comply with our <a href="http://creativecommons.org/policies">policies</a>. Among other things, if you use the logos on a website or on your work, you may not alter the logos in any respect—such as by changing the font, the proportions, or the colors. CC's buttons, name, and corporate logo (the “CC” in a circle) are trademarks of Creative Commons. You cannot use them in ways not permitted by our policies unless you first receive express, written permission. This means, for example, that you cannot (without our permission) print your own buttons and t-shirts using CC logos, although you can purchase them in CC’s <a href="https://creativecommons.net/store/">store</a>.</p>
<p><span id="I_love_what_Creative_Commons_does._How_can_I_help.3F"></span></p>
<h3 id="i-love-creative-commons.-how-can-i-help">I love Creative Commons. How can I help?</h3>
<p>Please support CC by making a donation through our <a href="http://creativecommons.net/">support page</a>. If you give $50 or more, you can get a special-edition t-shirt only available to CC supporters. Donations and shipping information can be handled through PayPal or by credit card. You can also support CC by visiting our <a href="http://creativecommons.net/store">store</a>.</p>
<p>CC always welcomes your feedback, which you can provide by emailing <script type="text/javascript">
<!--
h='&#x63;&#114;&#x65;&#x61;&#116;&#x69;&#118;&#x65;&#x63;&#x6f;&#x6d;&#x6d;&#x6f;&#110;&#x73;&#46;&#x6f;&#114;&#x67;';a='&#64;';n='&#x69;&#110;&#102;&#x6f;';e=n+a+h;
document.write('<a h'+'ref'+'="ma'+'ilto'+':'+e+'" clas'+'s="em' + 'ail">'+e+'<\/'+'a'+'>');
// -->
</script><noscript>&#x69;&#110;&#102;&#x6f;&#32;&#x61;&#116;&#32;&#x63;&#114;&#x65;&#x61;&#116;&#x69;&#118;&#x65;&#x63;&#x6f;&#x6d;&#x6d;&#x6f;&#110;&#x73;&#32;&#100;&#x6f;&#116;&#32;&#x6f;&#114;&#x67;</noscript>. You can also participate in CC's <a href="http://creativecommons.org/contact#discuss">email discussion lists</a> and share feedback and ideas in one of those forums.</p>
<p>If you are a software developer, sysadmin, or have other technical expertise, please <a href="http://lists.ibiblio.org/mailman/listinfo/cc-devel">join our developer community</a> and help build the tools that build the commons.</p>
<p>Finally, one of the best ways to support CC is by supporting our causes yourself. Follow our <a href="http://creativecommons.org/weblog/">blog</a> to find out about current issues where you can help get involved and spread the word, and advocate for free and open licensing in your own communities.</p>
<p><span id="Who_funds_Creative_Commons.3F"></span></p>
<h3 id="why-does-creative-commons-run-an-annual-fundraising-campaign-what-is-the-money-used-for-and-where-does-it-go">Why does Creative Commons run an annual fundraising campaign? What is the money used for and where does it go?</h3>
...
<li>advocate for CC licensing and open policies in <a href="http://creativecommons.org/education">education</a>, <a href="http://creativecommons.org/science">science</a>, and <a href="http://creativecommons.org/culture">culture</a>, and</li>
...
<p>...we need $ to make it all happen! For more information, please take a look at our <a href="http://dispatches.creativecommons.org/">Annual Report</a>.</p>
<p>Creative Commons has always relied on the generosity of both individuals and organizations to fund its ongoing operations. It is essential we have the public's support because it is the creators and users of CC material who make our tools relevant in this digital age. They depend on the tools and services CC provides through their reuse and remix of the rich, open resources available on <a href="http://en.wikipedia.org">Wikipedia</a>, <a href="http://www.flickr.com">Flickr</a>, <a href="http://soundcloud.com/‎">SoundCloud</a>, <a href="http://www.vimeo.com/‎">Vimeo</a>, <a href="http://www.europeana.eu/">‎Europeana</a>, <a href="http://ocw.mit.edu/">MIT OpenCourseWare</a>, the <a href="http://www.plos.org/‎Public">Library of Science</a>, <a href="http://www.aljazeera.com/‎">Al Jazeera</a>, and <a href="http://youtube.com">YouTube</a>—just to name a few. Many of these people donate $10, $25, or $50 to CC, to help keep it up and running so we can continue to provide our tools and services for free, as a nonprofit organization. The more people who <a href="https://creativecommons.net/">donate</a> to CC, the more independent it will remain.</p>
<h2 id="general-license-information">General License Information</h2>
...
<h3 id="what-are-creative-commons-licenses">What are Creative Commons licenses?</h3>
<p><a href="http://creativecommons.org/licenses">Creative Commons licenses</a> provide an easy way to manage the copyright terms that attach automatically to all creative material under <a href="Frequently_Asked_Questions#What_is_copyright_and_why_does_it_matter.3F" title="wikilink">copyright</a>. Our licenses allow that material to be shared and reused under terms that are flexible and legally sound. Creative Commons offers a core suite of six copyright licenses. Because there is no single &quot;Creative Commons license,&quot; it is important to identify <a href="http://creativecommons.org/licenses/">which of the six licenses</a> you are applying to your material, which of the six licenses has been applied to material that you intend to use, and in both cases the specific version.</p>
...
<p>CC licenses may be applied to any type of work, including <a href="OER" title="wikilink">educational resources</a>, <a href="Musician" title="wikilink">music</a>, <a href="Photographer" title="wikilink">photographs</a>, <a href="Data" title="wikilink">databases</a>, <a href="Government_use_of_Creative_Commons" title="wikilink">government and public sector information</a>, and <a href="Case_Studies" title="wikilink">many other types of material</a>. The only categories of works for which CC does not recommend its licenses are <a href="#Can_I_apply_a_Creative_Commons_license_to_software.3F" title="wikilink">computer software</a> and hardware. You should also not apply Creative Commons licenses to works that are <a href="#May_I_apply_a_Creative_Commons_license_to_a_work_in_the_public_domain" title="wikilink">no longer protected by copyright or are otherwise in the public domain</a>. Instead, for those works in the worldwide public domain, we recommend that you mark them with the <a href="http://creativecommons.org/about/pdm">Public Domain Mark</a>.</p>
<h3 id="how-do-cc-licenses-operate">How do CC licenses operate?</h3>
<p>CC licenses are operative only when applied to material in which a <a href="Frequently_Asked_Questions#What_is_copyright_and_why_does_it_matter.3F" title="wikilink">copyright</a> exists, and even then only when a particular use would otherwise not be permitted by copyright. Note that the latest version of CC licenses also applies to rights similar to copyright, such as <a href="#What_are_neighboring_rights.3F" title="wikilink">neighboring rights</a> and <a href="#What_are_sui_generis_database_rights.3F" title="wikilink">sui generis database rights</a>. <a href="Frequently_Asked_Questions#Can_I_use_CC_licenses_to_license_rights_other_than_copyright.3F" title="wikilink">Learn more about the scope of the licenses.</a> This means that CC license terms and conditions are <strong>not</strong> triggered by <a href="#Do_Creative_Commons_licenses_affect_fair_use.2C_fair_dealing.2C_or_other_exceptions_to_copyright.3F" title="wikilink">uses permitted under any applicable exceptions and limitations to copyright</a>, nor do license terms and conditions apply to elements of a licensed work that are in the public domain. This also means that CC licenses do not contractually impose restrictions on uses of a work where there is no underlying copyright. This feature (and others) <a href="Data#What_is_the_difference_between_the_Open_Data_Commons_licenses_and_the_CC_4.0_licenses.3F" title="wikilink">distinguish CC licenses from some other open licenses</a> like the <a href="http://opendatacommons.org/licenses/odbl/">ODbL</a> and <a href="http://opendatacommons.org/licenses/by/">ODC-BY</a>, both of which are intended to <a href="http://opendatacommons.org/faq/licenses/#db-versus-contents">impose contractual conditions and restrictions</a> on the reuse of databases in jurisdictions where there is no underlying copyright or sui generis database right.</p>
<p>All CC licenses are non-exclusive: <a href="Frequently_Asked_Questions#Can_I_enter_into_separate_or_supplemental_agreements_with_users_of_my_work.3F" title="wikilink">creators and owners can enter into additional, different licensing arrangements</a> for the same material at any time (often referred to as “dual-licensing” or “multi-licensing”). However, <a href="Frequently_Asked_Questions#What_if_I_change_my_mind_about_using_a_CC_license.3F" title="wikilink">CC licenses are not revocable</a> once granted unless there has been a breach, and even then the license is terminated only for the breaching licensee.</p>
<p>There are also <a href="http://creativecommons.org/videos/">videos and comics</a> that offer visual descriptions of how CC licenses work.</p>
<h3 id="which-is-the-latest-version-of-the-licenses-offered-by-creative-commons">Which is the latest version of the licenses offered by Creative Commons?</h3>
<p>In November 2013, Creative Commons published the version 4.0 license suite. These licenses are the most up-to-date licenses offered by CC, and are recommended over all prior versions. You can see how the licenses have been improved over time on the <a href="License%20versions" title="wikilink">license versions page</a>. 4.0 has been drafted to be internationally valid, and will have official translations becoming available after publication.</p>
<p><span id="Do_Creative_Commons_licenses_affect_fair_use.2C_fair_dealing_or_other_exceptions_to_copyright.3F"></span></p>
<h3 id="do-creative-commons-licenses-affect-exceptions-and-limitations-to-copyright-such-as-fair-dealing-and-fair-use">Do Creative Commons licenses affect exceptions and limitations to copyright, such as fair dealing and fair use?</h3>
<p>No. By design, CC licenses do not reduce, limit, or restrict any rights under exceptions and limitations to copyright, such as <a href="http://en.wikipedia.org/wiki/Fair_use">fair use</a> or <a href="http://en.wikipedia.org/wiki/Fair_dealing">fair dealing</a>. If your use of CC-licensed material would otherwise be allowed because of an applicable exception or limitation, you do not need to rely on the CC license or comply with its terms and conditions. <a href="Frequently_Asked_Questions#How_do_CC_licenses_operate.3F" title="wikilink">This is a fundamental principle of CC licensing.</a></p>
<h3 id="who-gives-permission-to-use-material-offered-under-creative-commons-licenses">Who gives permission to use material offered under Creative Commons licenses?</h3>
...
<h3 id="are-creative-commons-licenses-enforceable-in-a-court-of-law">Are Creative Commons licenses enforceable in a court of law?</h3>
<p>Creative Commons licenses are drafted to be enforceable around the world, and have been <a href="http://wiki.creativecommons.org/Case_Law">enforced in court</a> in various jurisdictions. To CC's knowledge, the licenses have never been held unenforceable or invalid.</p>
...
<h3 id="what-happens-if-someone-applies-a-creative-commons-license-to-my-work-without-my-knowledge-or-authorization">What happens if someone applies a Creative Commons license to my work without my knowledge or authorization?</h3>
<p>CC <a href="http://wiki.creativecommons.org/Before_Licensing">alerts prospective licensors</a> they need to have all necessary rights before applying a CC license to a work. If that is not the case and someone has marked your work with a CC license without your authorization, you should contact that person and tell them to remove the license from your work. You may also wish to contact a lawyer. Creative Commons is not a law firm and cannot represent you or give you legal advice, but there are <a href="#Can_Creative_Commons_give_legal_advice_about_its_licenses_or_help_with_CC_license_enforcement.3F" title="wikilink">lawyers who have identified themselves as interested in representing people in CC-related matters</a>.</p>
...
<p>CC recommends that you take advantage of the improvements in the 4.0 suite explained on the <a href="License_versions" title="wikilink">license versions page</a> unless there are <a href="#Should_I_choose_an_international_license_or_a_ported_license.3F" title="wikilink">particular considerations you are aware of</a> that would require a ported license.</p>
<h3 id="can-i-include-a-work-licensed-with-cc-by-in-a-wikipedia-article-even-though-they-use-a-cc-by-sa-license">Can I include a work licensed with CC BY in a Wikipedia article even though they use a CC BY-SA license?</h3>
<p>Yes. Works licensed under CC BY may be incorporated into works that are licensed under CC BY-SA. For example, you may incorporate a CC BY photograph into a Wikipedia article so long as you keep all copyright notices intact, provide proper attribution, and otherwise comply with the terms of CC BY. <a href="http://creativecommons.org/licenses/">Learn more</a> about the licenses.</p>
<p><span id="What_should_IGOs_consider_before_applying_a_CC_license.3F"></span> <span id="Do_CC_licenses_impose_obligations_on_IGOs_.28or_other_licensors.29_that_could_result_in_liability.3F"></span> <span id="What_law_would_be_applied_if_an_IGO_itself_chooses_to_enforce_the_terms_of_the_license_against_a_violator.3F"></span> <span id="#Why_should_governments_and_intergovernmental_organizations_.28.22IGOs.22.29_use_CC_licenses.3F"></span></p>
<h3 id="can-governments-and-intergovernmental-organizations-igos-use-cc-licenses">Can governments and intergovernmental organizations (&quot;IGOs&quot;) use CC licenses?</h3>
<p>Yes, anyone may use CC licenses for material they own, including governments and IGOs, and these institutions <a href="Government" title="wikilink">frequently use CC licenses on their copyrightable material</a>. The reasons for doing so vary, and often include a desire to maximize the impact and utility of works for educational and informational purposes, and to enhance transparency.</p>
<p>Creative Commons licenses have <a href="http://creativecommons.org/licenses/">desirable features</a> that make them the preferred choice over custom licenses. CC licenses are standard and interoperable, which means material published by different creators using the same type of CC license can be translated, modified, compiled, and remixed without legal barriers depending on the <a href="#Can_I_combine_works_that_use_different_Creative_Commons_licenses_into_my_work?" title="wikilink">particular license applied</a>. Creative Commons licenses are also machine-readable, allowing CC-licensed works to be easily discovered via search engines such as Google. These features maximize distribution, reuse, and impact of works published by governments and IGOs.</p>
<p>Though we encourage anyone to use version 4.0, which is internationally valid and may be used by individuals as well as organizations, there is an IGO ported version of 3.0 that IGOs may also use. Read more about how <a href="government" title="wikilink">governments</a> and <a href="IGO" title="wikilink">IGOs</a> use and leverage CC licenses and legal tools, considerations for using our licenses, and <a href="Intergovernmental_Organizations#FAQ:_CC_Licenses_and_IGOs" title="wikilink">how they operate in the IGO context.</a></p>
<p><span id="What_are_the_official_translations_of_the_CC_licenses.3F"></span> <span id="officialtranslations"></span></p>
<h3 id="what-are-the-official-translations-of-the-cc-licenses-and-cc0">What are the official translations of the CC licenses and CC0?</h3>
<p>Official language translations will be available for the 4.0 licenses and CC0. When you license your own work, you may use or link to the text of any available official translation. When you reuse CC-licensed material, you may comply with the license conditions by referring to any available official translation of the license. These translations are linguistic translations of the English version which adhere as closely as possible to the original text. These translations have been done by our affiliates in accordance with the <a href="Legal%20Code%20Translation%20Policy" title="wikilink">Legal Code Translation Policy</a> and with the oversight and detailed review of the CC legal team. Note that these are equivalents of the original English; these translations are <em>not</em> <a href="Frequently_Asked_Questions#What_are_the_international_.28.E2.80.9Cunported.E2.80.9D.29_Creative_Commons_licenses.2C_and_why_does_CC_offer_.E2.80.9Cported.E2.80.9D_licenses.3F" title="wikilink">jurisdiction ported versions</a>. You may find a list of all available translations <a href="Legal_Tools_Translation#Published_translations" title="wikilink">here</a>.</p>
<p>For versions 3.0 and earlier, official translations are not available. Some unofficial translations were made for informational purposes only. (Jurisdiction ported versions of version 3.0 and earlier were generally published in the official language(s) of the appropriate jurisdiction. However, the ported licenses are <a href="Frequently_Asked_Questions#What_should_I_know_about_differences_between_the_international_licenses_and_the_ported_licenses.3F" title="wikilink">not equivalent</a> to the international licenses, and do not serve as substitutable references for purposes of complying with the terms and conditions of the licenses.)</p>
<h3 id="what-is-a-by-sa-compatible-license">What is a BY-SA Compatible License?</h3>
...
<h3 id="what-things-should-i-think-about-before-i-apply-a-creative-commons-license">What things should I think about before I apply a Creative Commons license?</h3>
...
<p>CC has identified <a href="Considerations%20for%20licensors%20and%20licensees" title="wikilink">some things that you should consider</a> before you apply a CC license, some of which relate to your ability to apply a CC license at all. Here are some highlights:</p>
<ul>
<li>Is the material copyrightable? If not, is it subject to <a href="#What_are_neighboring_rights.3F" title="wikilink">neighboring rights</a> or <a href="#What_are_sui_generis_database_rights.3F" title="wikilink">sui generis database rights</a>? CC licenses do not apply to material in the <a href="#What_is_the_public_domain.3F" title="wikilink">public domain</a>. Different countries have different standards for what is in the public domain.</li>
...
<li>Are you aware that CC licenses <a href="#What_if_I_change_my_mind_about_using_a_CC_license.3F" title="wikilink">are not revocable</a>? You are free to stop offering material under a CC license at any time, but this will not affect the rights associated with any copies of your work already in circulation. (Any particular licensee may lose his or her rights after violating the license, but this does not affect continual use of the work by other licensees.)</li>
<li>Are you a member of a <a href="#What_are_collecting_societies.3F" title="wikilink">collecting society</a>? If you are, you should <a href="#Can_I_use_a_Creative_Commons_license_if_I_am_a_member_of_a_collecting_society.3F" title="wikilink">make sure that you are able to use CC licenses for your materials</a>.</li>
<li>Always read the terms and conditions of the specific license you plan to apply. Additionally, there are several <a href="License%20versions" title="wikilink">terms that may differ in the earlier versions of the license</a>, both unported and ported. <a href="Frequently_Asked_Questions#Should_I_choose_an_international_license_or_a_ported_license.3F" title="wikilink">If you choose to use a pre-4.0 version or any ported version</a>, clauses such as choice of law may affect your desired choice of license.</li>
</ul>
<p><span id="Which_Creative_Commons_license_should_I_choose.3F"></span></p>
<h3 id="how-should-i-decide-which-license-to-choose">How should I decide which license to choose?</h3>
<p>If you are unsure which license best suits your needs, there are plenty of resources to help rights holders choose the right CC license. CC Australia has developed a <a href="http://creativecommons.org.au/learn-more/fact-sheets/which-creative-commons-licence-is-right-for-me-poster">flow chart</a> that may be useful in helping you settle on the right license for your work. Creative Commons has also compiled <a href="http://creativecommons.org/examples">a list of examples</a> that demonstrate how various licenses fit into licensors' overall strategies. You can also <a href="http://thepowerofopen.org/">read case studies</a> of others who are using CC licenses. The CC community can also respond to questions, and may have already addressed issues you raise. The CC community <a href="http://creativecommons.org/discuss">email discussion lists</a> and discussion archives may be useful resources.</p>
<p>Finally, you may also want to <a href="#Can_Creative_Commons_give_legal_advice_about_its_licenses_or_help_with_CC_license_enforcement.3F" title="wikilink">consult with a lawyer</a> to obtain advice on the best license for your needs.</p>
<p><span id="Why_should_I_use_the_latest_version_.28currently_3.0.29_of_the_Creative_Commons_licenses.3F"></span></p>
<h3 id="why-should-i-use-the-latest-version-of-the-creative-commons-licenses">Why should I use the latest version of the Creative Commons licenses?</h3>
<p>The latest version of the Creative Commons licenses is version 4.0. You should always use the latest version of the Creative Commons licenses in order to take advantage of the many improvements described on the <a href="License%20versions" title="wikilink">license versions page</a>. In particular, 4.0 is meant to be better suited to international use, and use in many different contexts, including <a href="Data" title="wikilink">sharing data</a>.</p>
<p><span id="What_if_CC_licenses_have_not_been_ported_to_my_jurisdiction_.28country.29.3F"></span></p>
<h3 id="what-if-cc-licenses-have-not-been-ported-to-my-jurisdiction">What if CC licenses have not been ported to my jurisdiction?</h3>
<p>All CC licenses are intended to work worldwide. Unless you have a specific reason to use a <a href="Frequently_Asked_Questions#Should_I_choose_an_international_license_or_a_ported_license.3F" title="wikilink">ported license</a>, we suggest you consider using one of the international licenses. 4.0 will support official translations of the international license for those who wish to use the licenses in another language.</p>
...
<p>You can <a href="Jurisdiction_Database" title="wikilink">use our jurisdiction database</a> to compare international licenses and ports on these issues and others, such as whether a ported license contains a choice of law or forum selection clause.</p>
<h3 id="why-should-i-use-the-license-chooser-what-if-i-dont">Why should I use the license chooser? What if I don’t?</h3>
<p>Licensors are not required to use the <a href="http://creativecommons.org/choose/">CC license chooser</a> or provide any information about themselves or their material when applying a CC license to their material. However, using the license chooser enables licensors to take advantage of the &quot;machine readable&quot; layer of CC licenses. Our <a href="ccrel" title="wikilink">machine-readable</a> code enhances the discoverability of your work because that code allows software, search engines, and other tools to recognize when something is licensed under a CC license. The code also facilitates attribution: when users click on the CC button placed on your site, they will be linked directly to HTML code that they can cut and paste to provide attribution.</p>
...
<h3 id="how-do-i-apply-a-creative-commons-license-to-my-material">How do I apply a Creative Commons license to my material?</h3>
<p><strong>For online material</strong>: Select the license that is appropriate for your material <a href="http://creativecommons.org/choose/">from the CC license chooser</a> and then follow the <a href="Marking_your_work_with_a_CC_license#How_to_use_the_CC_License_Chooser" title="wikilink">instructions</a> to include the HTML code. The code will automatically generate a <a href="#What_do_the_Creative_Commons_buttons_do.3F" title="wikilink">license button</a> and a statement that your material is licensed under a CC license. If you are only licensing part of a work (for example, if you have created a video under a CC license but are using a song under a different license), be sure to clearly <a href="Marking/Creators" title="wikilink">mark</a> which parts are under the CC license and which parts are not. The HTML code will also include metadata, which allows the material to be discovered via <a href="http://search.creativecommons.org/">Creative Commons-enabled search engines</a>.</p>
<p><strong>For offline material</strong>: Identify which license you wish to apply to your work and either (a) <a href="Marking_your_work_with_a_CC_license#Example:_Offline_document" title="wikilink">mark your work</a> with a statement such as, “This work is licensed under the Creative Commons [insert description] License. To view a copy of the license, visit [insert url]&quot;; or (b) insert the applicable <a href="#What_do_the_Creative_Commons_buttons_do.3F" title="wikilink">license buttons</a> with the same statement and URL link.</p>
<p><strong>For third-party platforms</strong>: Many <a href="Marking_your_work_with_a_CC_license#Content-sharing_platforms" title="wikilink">media platforms</a> like <a href="http://www.flickr.com/">Flickr</a>, <a href="http://www.youtube.com/">YouTube</a>, and <a href="https://soundcloud.com/">SoundCloud</a> have built-in Creative Commons capabilities, letting users mark their material with a CC license through their account settings. The benefit of using this functionality is that it allows other people to find your content when <a href="http://search.creativecommons.org/">searching on those platforms for CC-licensed material</a>. If the platform where you're uploading your content does not support CC licensing, you can still identify your content as CC-licensed in the text description of your content.</p>
...
<p>CC offers resources on the <a href="Marking/Creators" title="wikilink">best practices for marking your material</a> and on <a href="Media:Creativecommons-licensing-and-marking-your-content_eng.pdf" title="wikilink">how to mark material in different media (.pdf)</a>.</p>
...
<h3 id="do-i-need-to-register-with-creative-commons-before-i-obtain-a-license">Do I need to register with Creative Commons before I obtain a license?</h3>
...
<p>CC does not require or provide any means for creators or other rights holders to register use of a CC license, <a href="Frequently_Asked_Questions#Does_Creative_Commons_collect_or_track_materials_licensed_under_a_CC_license.3F" title="wikilink">nor does CC maintain a database of works</a> distributed under Creative Commons licenses. CC also does not require registration of the work with a national copyright agency.</p>
...
<h3 id="what-do-the-terms-and-conditions-of-a-cc-license-apply-to">What do the terms and conditions of a CC license apply to?</h3>
<p>Although CC licenses get attached to tangible works (such as photos and novels), the license terms and conditions apply to the licensor’s <a href="FAQ#How_do_CC_licenses_operate.3F" title="wikilink">copyright</a> in the licensed material. The public is granted “permission to exercise” those rights in <a href="FAQ#Can_I_take_a_CC-licensed_work_and_use_it_in_a_different_format.3F" title="wikilink">any medium or format</a>. It is the expression that is protected by copyright and covered by the licenses, not any particular medium or format in which the expression is manifested. This means, for example, that a CC license <a href="Frequently_Asked_Questions#Can_I_apply_a_CC_license_to_low-resolution_copies_of_a_licensed_work_and_reserve_more_rights_in_high-resolution_copies.3F" title="wikilink">applied to a digitized copy</a> of a novel grants the public permission under copyright to use a print version of the same novel on the same terms and conditions (though you may have to purchase the print version from a bookstore).</p>
<h3 id="can-i-apply-a-creative-commons-license-to-software">Can I apply a Creative Commons license to software?</h3>
<p>We recommend against using Creative Commons licenses for software. Instead, we strongly encourage you to use one of the very good software licenses which are already available. We recommend considering <a href="https://www.gnu.org/licenses/license-recommendations.html">licenses made available</a> by the <a href="http://www.fsf.org/">Free Software Foundation</a> or <a href="http://opensource.org/licenses">listed as “open source”</a> by the <a href="http://www.opensource.org/">Open Source Initiative</a>.</p>
<p>Unlike software-specific licenses, CC licenses do not contain specific terms about the distribution of source code, which is often important to ensuring the free reuse and modifiability of software. Many software licenses also address patent rights, which are important to software but may not be applicable to other copyrightable works. Additionally, our licenses are currently not compatible with the major software licenses, so it would be difficult to integrate CC-licensed work with other free software. Existing software licenses were designed specifically for use with software and offer a similar set of rights to the Creative Commons licenses.</p>
<p>Version 4.0 of CC's Attribution-ShareAlike (BY-SA) license is <a href="http://creativecommons.org/compatiblelicenses">one-way compatible</a> with the <a href="https://www.gnu.org/copyleft/gpl.html">GNU General Public License version 3.0</a> (GPLv3). This compatibility mechanism is designed for situations in which content is integrated into software code in a way that makes it difficult or impossible to distinguish the two. There are special considerations required before using this compatibility mechanism. Read more about it <a href="ShareAlike_compatibility:_GPLv3" title="wikilink">here</a>.</p>
<p>Also, the CC0 Public Domain Dedication <strong>is</strong> GPL-compatible and acceptable for software. For details, <a href="CC0_FAQ#May_I_apply_CC0_to_computer_software.3F_If_so.2C_is_there_a_recommended_implementation.3F" title="wikilink">see the relevant CC0 FAQ entry</a>.</p>
<p>While we recommend against using a CC license on software itself, CC licenses may be used for software documentation, as well as for separate artistic elements such as game art or music.</p>
<p><span id="Can_I_apply_a_Creative_Commons_license_to_data_or_a_database.3F"></span></p>
<h3 id="can-i-apply-a-creative-commons-license-to-databases">Can I apply a Creative Commons license to databases?</h3>
<p>Yes. CC licenses <a href="Data#Can_databases_be_released_under_CC_licenses.3F" title="wikilink">can be used on databases</a>. In the 4.0 license suite, applicable <a href="#What_are_sui_generis_database_rights.3F" title="wikilink">sui generis database rights</a> are licensed under the same license conditions as copyright. Many <a href="Data_and_CC_licenses" title="wikilink">governments and others use CC licenses</a> for data and databases.</p>
<p>For more detailed information about how CC licenses apply to data and databases, visit our detailed <a href="Data" title="wikilink">Data FAQ</a>.</p>
<h3 id="could-i-use-a-cc-license-to-share-my-logo-or-trademark">Could I use a CC license to share my logo or trademark?</h3>
<p>Creative Commons does not recommend using a CC license on a logo or trademark. While a logo or trademark can be covered by copyright laws in addition to trademark laws, the special purposes of trademarks make CC licenses an unsuitable mechanism for sharing them in most cases. Generally, logos and trademarks are used to identify the origin of a product or service, or to indicate that it meets a specific standard or quality. Allowing anyone to reuse or modify your logo or trademark as a matter of copyright could result in your inability to limit use of your logo or trademark selectively to accomplish those purposes. Applying a CC license to your trademarks and logos could even result in a loss of your trademark rights altogether. See <a href="#Can_I_place_a_trademark_on_a_work_and_offer_the_work_under_a_CC_license_without_also_licensing_or_otherwise_affecting_rights_in_the_trademark.3F_If_so.2C_how.3F" title="wikilink">below</a> for more about how to license material that includes a trademark or logo.</p>
<p>There are other ways to share your logos and trademarks widely while preserving your trademark rights. Establishing a trademark policy that grants permissions in advance for limited uses is one common alternative. <a href="http://www.mozilla.org/foundation/trademarks/policy.html">Mozilla</a>, <a href="http://wikimediafoundation.org/wiki/Trademark_policy">Wikimedia</a>, and <a href="http://creativecommons.org/policies">Creative Commons</a> have each published policies that accomplish the dual objectives of encouraging reuse and preserving trademark rights.</p>
...
<h3 id="may-i-apply-a-creative-commons-license-to-a-work-in-the-public-domain">May I apply a Creative Commons license to a work in the public domain?</h3>
<p>CC licenses should not be applied to works in the worldwide <a href="#What_is_the_public_domain.3F" title="wikilink">public domain</a>. All CC licenses are clear that they <a href="#Do_Creative_Commons_licenses_affect_exceptions_and_limitations_to_copyright.2C_such_as_fair_dealing_and_fair_use.3F" title="wikilink">do not have the effect</a> of placing restrictions on material that would otherwise be unrestricted, and you cannot remove a work from the public domain by applying a CC license to it. If you want to dedicate your own work to the public domain before the expiration of applicable copyright or similar rights, use CC's legally robust <a href="http://creativecommons.org/about/cc0|CC0">public domain dedication</a>. If a work is already in the worldwide public domain, you should mark it with CC's <a href="http://creativecommons.org/about/pdm">Public Domain Mark</a>.</p>
...
<p>Creators may also apply Creative Commons licenses to material they create that are adapted from public domain works, or to remixed material, databases, or collections that include work in the public domain. However, in each of these instances, the license does not affect parts of the work that are unrestricted by copyright or similar rights. We strongly encourage you to <a href="Marking/Creators/Marking_third_party_content" title="wikilink">mark the public domain material</a>, so that others know they are also free to use this material without legal restriction.</p>
<p><span id="If_I_take_a_photograph_of_another_work_that_is_out_of_copyright_and_in_the_public_domain,_can_I_apply_a_CC_license_to_my_photo.3F"></span></p>
<h3 id="if-i-take-a-photograph-of-another-work-that-is-in-the-public-domain-can-i-apply-a-cc-license-to-my-photo">If I take a photograph of another work that is in the public domain, can I apply a CC license to my photo?</h3>
...
<p>In practice, if your photograph is sufficiently creative to attract copyright protection, people will likely have to comply with the license conditions if they reproduce your entire photograph in verbatim form, absent some applicable exception or limitation such as fair use. However, <a href="Frequently_Asked_Questions#Do_I_always_have_to_comply_with_the_license_terms.3F_If_not.2C_what_are_the_exceptions.3F" title="wikilink">they would not have to comply with the license conditions if they reproduce only those parts of the work in the public domain</a>. This is because your copyright in the adaptation only extends to the material you contributed, not to the underlying work.</p>
<h3 id="may-i-apply-a-cc-license-to-my-work-if-it-incorporates-material-used-under-fair-use-or-another-exception-or-limitation-to-copyright">May I apply a CC license to my work if it incorporates material used under fair use or another exception or limitation to copyright?</h3>
...
<h3 id="can-i-use-cc-licenses-to-license-rights-other-than-copyright">Can I use CC licenses to license rights other than copyright?</h3>
<p>CC licenses are copyright licenses, but the latest version of CC licenses also cover certain other rights similar to copyright, including <a href="Frequently_Asked_Questions#What_are_neighboring_rights.3F" title="wikilink">performance, broadcast, and sound recording rights</a>, as well as <a href="#What_are_sui_generis_database_rights.3F" title="wikilink">sui generis database rights</a>. You may apply a 4.0 license to material subject to any of those rights, whether or not the material is also subject to copyright. Note that the scope of prior versions of CC licenses was more limited. You should refer to our <a href="License%20Versions" title="wikilink">license versions page</a> for details.</p>
<h3 id="how-do-creative-commons-licenses-affect-my-moral-rights-if-at-all">How do Creative Commons licenses affect my moral rights, if at all?</h3>
<p>As a general matter, all CC licenses preserve <a href="#What_are_moral_rights.3F" title="wikilink">moral rights</a> to the extent they exist (they do not exist everywhere), but allow uses of the work in ways contemplated by the license that might otherwise violate moral rights. If you apply a 4.0 license to your material, you agree to waive or not assert any moral rights you have, to the limited extent necessary to allow the public to exercise the licensed rights. This is designed to minimize the effect of moral rights on licensees’ ability to use the work, and ensure that the license works internationally as intended. The attribution requirement contained in all of our licenses is intended to satisfy the moral right of attribution, but it must be adhered to whether or not the applicable jurisdiction recognizes moral rights.</p>
<p><a href="License%20Versions" title="wikilink">Earlier versions</a> of the license are also intended to minimize the effect of moral rights on otherwise-permitted uses, but the language in the licenses differs. Additionally, jurisdiction ports of earlier versions of CC licenses often contain versions of the moral rights language designed to account for moral rights legislation in a particular jurisdiction. If you are applying a ported license to your work, you may wish to review the moral rights language in the particular license.</p>
<p>You can also <a href="Jurisdiction_Database" title="wikilink">compare how different jurisdictions have implemented this provision</a>, or <a href="License_versions" title="wikilink">browse the license versions page</a> to compare the treatment of this issue across the different versions of the CC licenses.</p>
...
<h3 id="can-i-offer-material-under-a-cc-license-that-has-my-trademark-on-it-without-also-licensing-or-affecting-rights-in-the-trademark">Can I offer material under a CC license that has my trademark on it without also licensing or affecting rights in the trademark?</h3>
...
<p>“<em>The text of and illustrations in this document are licensed by Red Hat under a Creative Commons Attribution–Share Alike 3.0 Unported license (&quot;CC-BY-SA&quot;). . . . Red Hat, Red Hat Enterprise Linux, the Shadowman logo, JBoss, MetaMatrix, Fedora, the Infinity Logo, and RHCE are trademarks of Red Hat, Inc., registered in the United States and other countries. For guidelines on the permitted uses of the Fedora trademarks, refer to <a href="https://fedoraproject.org/wiki/Legal:Trademark_guidelines" class="uri">https://fedoraproject.org/wiki/Legal:Trademark_guidelines</a>.</em>”</p>
<h3 id="how-are-publicity-privacy-and-personality-rights-affected-when-i-apply-a-cc-license">How are publicity, privacy, and personality rights affected when I apply a CC license?</h3>
<p>When you apply the latest version (4.0) of a CC license to your material, you also agree to waive or not assert any <a href="#What_are_publicity.2C_personality.2C_and_privacy_rights.3F" title="wikilink">publicity, privacy, or personality rights</a> that you hold in the material you are licensing, to the limited extent necessary for others to exercise the licensed rights. For example, if you have licensed a photograph of yourself, you may not assert your right of privacy to have the photo removed from further distribution. (Under the 3.0 and earlier licenses, this is implied but not explicit.) If you do not wish to license these rights in this way, you should not apply a CC license to the material where this is a concern.</p>
...
<h3 id="can-i-apply-a-cc-license-to-low-resolution-copies-of-a-licensed-work-and-reserve-more-rights-in-high-resolution-copies">Can I apply a CC license to low-resolution copies of a licensed work and reserve more rights in high-resolution copies?</h3>
<p>You may license your copyright or distribute your work under more than one set of terms. For example, you may publish a photograph on your website, but only distribute high-resolution copies to people who have paid for access. This is a practice CC supports. However, if the low-resolution and high-resolution copies are the <a href="Frequently_Asked_Questions#How_do_I_know_if_a_low-resolution_photo_and_a_high-resolution_photo_are_the_same_work.3F" title="wikilink">same work under applicable copyright law</a>, permission under a CC license is not limited to a particular copy, and someone who receives a copy in high resolution may use it under the terms of the CC license applied to the low-resolution copy.</p>
<p>Note that, although CC <a href="Frequently_Asked_Questions#Can_I_enter_into_separate_or_supplemental_agreements_with_users_of_my_work.3F" title="wikilink">strongly discourages the practice</a>, CC cannot prevent licensors from attempting to impose restrictions through separate agreements on uses the license otherwise would allow. In that case, licensees may be <a href="FAQ#What_if_I_have_received_CC-licensed_material_with_additional_restrictions.3F" title="wikilink">contractually restricted</a> from using the high-resolution copy, for example, even if the licensor has placed a CC license on the low-resolution copy.</p>
<h3 id="can-i-use-a-creative-commons-license-if-i-am-a-member-of-a-collecting-society">Can I use a Creative Commons license if I am a member of a collecting society?</h3>
<p>Creators and other rights holders may wish to check with their <a href="#What_are_collecting_societies.3F" title="wikilink">collecting society</a> before applying a CC license to their material. Many rights holders who are members of a collecting society can waive the right to collect royalties for uses allowed under the license, but only to the extent their societies allow.</p>
<p>Collecting societies in several countries including Australia, Finland, France, Germany, Luxembourg, Norway, Spain, Taiwan, and the Netherlands take an assignment of rights from creators in present and future works and manage them, so that the societies effectively become the owner of these rights. (In France it is called a “mandate” of rights but has similar practical effect.) Creators in these jurisdictions who belong to collecting societies may not be able to license their material under CC licenses because the collecting societies own the necessary rights, not the creators. CC is <a href="Collecting_Society_Projects" title="wikilink">working with several collecting societies</a> and running pilot programs that allow creators to use CC licenses in some circumstances.</p>
...
<h3 id="can-i-still-make-money-from-a-work-i-make-available-under-a-creative-commons-license">Can I still make money from a work I make available under a Creative Commons license?</h3>
...
<p>CC's <a href="#Does_my_use_violate_the_NonCommercial_clause_of_the_licenses.3F" title="wikilink">NonCommercial (NC)</a> licenses allow rights holders to maximize distribution while maintaining control of the commercialization of their works. If you want to reserve the right to commercialize your work, you may do this by choosing a license with the NC condition. If someone else wants to use your work commercially and you have applied an NC license to your work, they must first get your permission. As the rights holder, you may still sell your own work commercially.</p>
...
<h3 id="can-i-insist-on-the-exact-placement-of-the-attribution-credit">Can I insist on the exact placement of the attribution credit?</h3>
...
<h3 id="can-i-change-the-license-terms-or-conditions">Can I change the license terms or conditions?</h3>
<p>Yes—but if you change the terms and conditions of any Creative Commons license, you <em>must no longer call, label, or describe the license as a “Creative Commons” or “CC” license</em>, nor can you use the <a href="http://creativecommons.org/policies">Creative Commons logos, buttons, or other trademarks</a> in connection with the modified license or your materials. Keep in mind that altering terms and conditions is distinct from <a href="Frequently_Asked_Questions#Can_I_waive_license_terms_or_conditions.3F" title="wikilink">waiving existing conditions or granting additional permissions</a> than those in the licenses. Licensors may always do so, and many choose to do so using the <a href="CCPlus" title="wikilink">CC+ protocol</a> to readily signal the waiver or additional permission on the CC license deed.</p>
<p>CC does not assert copyright in the text of its licenses, so you are permitted to modify the text as long as you do not use the CC marks to describe it. However, we do not recommend this. We also advise against <a href="Modifying_the_CC_licenses" title="wikilink">modifying our licenses</a> through indirect means, such as in your terms of service. A modified license very likely will not be compatible with the same CC license (unmodified) applied to other material. This would prevent licensees from using, combining, or remixing content under your customized license with other content under the same or compatible CC licenses.</p>
...
<h3 id="can-i-waive-license-terms-or-conditions">Can I waive license terms or conditions?</h3>
<p>Yes. You may always choose to waive some license terms or conditions. Material licensed under a CC license but with additional permissions granted or conditions waived may be compatibly licensed with other material under the same license. Our <a href="CCPlus" title="wikilink">CC+ protocol</a> provides a mechanism for facilitating that grant or waiver.</p>
<p><span id="Can_I_enter_into_separate_agreements_or_understandings_with_users_outside_the_scope_of_the_license.3F"></span></p>
<h3 id="can-i-enter-into-separate-or-supplemental-agreements-with-users-of-my-work">Can I enter into separate or supplemental agreements with users of my work?</h3>
...
<h3 id="what-can-i-do-if-i-offer-my-material-under-a-creative-commons-license-and-i-do-not-like-the-way-someone-uses-it">What can I do if I offer my material under a Creative Commons license and I do not like the way someone uses it?</h3>
...
<p>First, all CC licenses <a href="#Do_I_need_to_be_aware_of_anything_else_when_providing_attribution.3F" title="wikilink">prohibit using the attribution requirement to suggest that the licensor endorses or supports a particular use</a>. Second, licensors may waive the attribution requirement, choosing not to be identified as the licensor, if they wish. Third, if the licensor does not like how the material has been modified or used, CC licenses require that the licensee <a href="License_Versions#Licensors_may_request_removal_of_attribution" title="wikilink">remove the attribution information upon request</a>. (In 3.0 and earlier, this is only a requirement for adaptations and collections; in 4.0, this also applies to the unmodified work.) Finally, anyone modifying licensed material must <a href="License_Versions#Modifications_and_adaptations_must_be_indicated" title="wikilink">indicate that the original has been modified</a>. This ensures that changes made to the original material--whether or not the licensor approves of them--are not attributed back to the licensor.</p>
...
<h3 id="what-do-i-do-if-someone-tries-to-place-effective-technological-measures-such-as-drm-on-my-cc-licensed-material">What do I do if someone tries to place effective technological measures (such as DRM) on my CC-licensed material?</h3>
<p>The use of <a href="#Frequently_Asked_Questions#Can_I_use_effective_technological_measures_.28such_as_DRM.29_when_I_share_CC-licensed_material.3F" title="wikilink">any effective technical protection measures (such as digital rights management or &quot;DRM&quot;)</a> by licensees to prevent others from exercising the licensed rights is prohibited.</p>
<p>Not all kinds of encryption or <a href="Frequently_Asked_Questions#Can_I_share_CC-licensed_material_on_password-protected_sites.3F" title="wikilink">access limitations</a> are prohibited by the licenses. For example, sending content via email and encrypting it with the recipient's public key does not restrict use of the work by the recipient. Likewise, limiting recipients to a particular set of users (for example, by requiring a username and password to enter a site) does not restrict further use of the content by the recipients. In these examples, these things do not prevent the recipient from exercising all of the rights granted by the license, including the right to redistribute it further.</p>
...
<h3 id="when-i-release-my-work-under-a-cc-license-in-one-format-e.g.-.pdf-can-i-restrict-licensees-from-changing-it-to-or-using-it-in-other-formats">When I release my work under a CC license in one format (e.g., .pdf), can I restrict licensees from changing it to or using it in other formats?</h3>
...
<h3 id="are-creative-commons-works-really-free-to-use">Are Creative Commons works really free to use?</h3>
...
<p>(If you wish to make uses that are not permitted by the license—for example, making a <a href="Frequently_Asked_Questions#Does_my_use_violate_the_NonCommercial_clause_of_the_licenses.3F" title="wikilink">commercial use</a> of an NC-licensed photo—the licensor may charge for those additional rights.)</p>
<h3 id="what-should-i-know-about-differences-between-the-international-licenses-and-the-ported-licenses">What should I know about differences between the international licenses and the ported licenses?</h3>
<p>As a licensee, you should always read and understand the relevant license's legal code before using CC-licensed material, particularly if you are using material that is licensed using a <a href="Frequently_Asked_Questions#What_are_the_international_.28.E2.80.9Cunported.E2.80.9D.29_Creative_Commons_licenses.2C_and_why_does_CC_offer_.E2.80.9Cported.E2.80.9D_licenses.3F" title="wikilink">ported license</a> with which you are unfamiliar. Our porting process involved adapting the international licenses to the legal framework of different jurisdictions, and in that process slight adjustments may have been made that you should make yourself aware of in advance of using the material. You can find more information about the ported licenses in the <a href="Jurisdiction%20Database" title="wikilink">Jurisdiction Database</a>.</p>
...
<h3 id="what-happens-if-i-want-to-use-the-material-in-a-way-that-is-not-permitted-by-the-license">What happens if I want to use the material in a way that is not permitted by the license?</h3>
<p>Contact the rights holders to ask for permission. Otherwise, <a href="Frequently_Asked_Questions#Do_I_always_have_to_comply_with_the_license_terms.3F_If_not.2C_what_are_the_exceptions.3F" title="wikilink">unless an exception or limitation to copyright applies</a>, your use of the material may violate the Creative Commons license. If you violate the terms of the license, your rights to use the material will be <a href="Frequently_Asked_Questions#How_can_I_lose_my_rights_under_a_Creative_Commons_license.3F_If_that_happens.2C_how_do_I_get_them_back.3F" title="wikilink">automatically terminated</a>, and you may be liable for copyright infringement.</p>
<h3 id="do-i-always-have-to-comply-with-the-license-terms-if-not-what-are-the-exceptions">Do I always have to comply with the license terms? If not, what are the exceptions?</h3>
...
<h3 id="how-do-i-properly-attribute-material-offered-under-a-creative-commons-license">How do I properly attribute material offered under a Creative Commons license?</h3>
<p>All CC licenses require users to attribute the creator of licensed material, unless the creator has <a href="#Can_I_waive_license_terms_or_conditions.3F" title="wikilink">waived that requirement</a>, not supplied a name, or <a href="#What_can_I_do_if_I_offer_my_material_under_a_Creative_Commons_license_and_I_do_not_like_the_way_someone_uses_it.3F" title="wikilink">asked that her name be removed</a>. Additionally, you must retain a copyright notice, a link to the license (or to the deed), a license notice, a notice about the disclaimer of warranties, and a URI if reasonable. For versions prior to 4.0, you must also provide the title of the work. (Though it is not a requirement in 4.0, it is still recommended if one is supplied.)</p>
<p>You must also indicate if you have <a href="License_Versions#Modifications_and_adaptations_must_be_marked_as_such" title="wikilink">modified the work</a>—for example, if you have taken an excerpt, or cropped a photo. (For versions prior to 4.0, this is only required if you have created an adaptation by contributing your own creative material, but it is recommended even when not required.) It is not necessary to note trivial alterations, such as correcting a typo or changing a font size. Finally, you must retain an indication of previous modifications to the work.</p>
...
<h3 id="does-my-use-violate-the-noncommercial-clause-of-the-licenses">Does my use violate the NonCommercial clause of the licenses?</h3>
...
<h3 id="can-i-take-a-cc-licensed-work-and-use-it-in-a-different-format">Can I take a CC-licensed work and use it in a different format?</h3>
...
<h3 id="how-do-i-know-if-a-low-resolution-photo-and-a-high-resolution-photo-are-the-same-work">How do I know if a low-resolution photo and a high-resolution photo are the same work?</h3>
...
<p>Under U.S. copyright law, for example, mechanical reproduction of a work into a different format [<a href="http://en.wikipedia.org/wiki/Bridgeman_Art_Library_v._Corel_Corp" class="uri">http://en.wikipedia.org/wiki/Bridgeman_Art_Library_v._Corel_Corp</a>. is unlikely to create a separate, new work]. Consequently, digitally enhancing or changing the format of a work <em>absent some originality</em>, such as expressive choices made in the enhancement or encoding, will not likely create a separate work for copyright purposes. The creative bar is low, but it is not non-existent. Accordingly, in some jurisdictions releasing a photograph under a CC license will give the public permission to reuse the photograph in a different resolution.</p>
<h3 id="can-i-use-effective-technological-measures-such-as-drm-when-i-share-cc-licensed-material">Can I use effective technological measures (such as DRM) when I share CC-licensed material?</h3>
...
<h3 id="can-i-share-cc-licensed-material-on-password-protected-sites">Can I share CC-licensed material on password-protected sites?</h3>
<p>Yes. This is not considered to be a prohibited measure, so long as the protection is merely limiting who may access the content, and does not restrict the authorized recipients from exercising the licensed rights. For example, you may post material under any CC license on a site restricted to members of a certain school, or to paying customers, but <a href="Frequently_Asked_Questions#Can_I_use_effective_technological_measures_.28such_as_DRM.29_when_I_share_CC-licensed_material.3F" title="wikilink">you may not place effective technological measures (including DRM) on the files</a> that prevents them from sharing the material elsewhere.</p>
...
<h3 id="can-i-share-cc-licensed-material-on-file-sharing-networks">Can I share CC-licensed material on file-sharing networks?</h3>
...
<h3 id="what-if-i-received-cc-licensed-material-encumbered-with-effective-technological-measures-such-as-drm">What if I received CC-licensed material encumbered with effective technological measures (such as DRM)?</h3>
...
<h3 id="what-if-i-have-received-cc-licensed-material-with-additional-restrictions">What if I have received CC-licensed material with additional restrictions?</h3>
<p>It is possible that CC-licensed material will appear on platforms that impose terms in addition to the copyright license (though <a href="Frequently_Asked_Questions#Can_I_enter_into_separate_or_supplemental_agreements_with_users_of_my_work.3F" title="wikilink">Creative Commons strongly discourages restrictions that interfere with exercise of the licensed rights</a>). These additional terms do not form part of the license for the work. For example, if you download CC-licensed material from a site that does not permit downloading, you may be breaking the terms of use of the site, but you are not infringing the CC license. See our guide to <a href="Modifying%20the%20CC%20licenses" title="wikilink">Modifying the CC licenses</a> for more guidance and information.</p>
...
<h3 id="can-i-combine-material-under-different-creative-commons-licenses-in-my-work">Can I combine material under different Creative Commons licenses in my work?</h3>
<p>It depends. The first question to ask is whether doing so constitutes an <a href="FAQ#When_is_my_use_considered_an_adaptation.3F" title="wikilink">adaptation.</a> If the combination does <strong><em>not</em></strong> create an adaptation, then you may combine any CC-licensed content so long as you provide attribution and comply with the NonCommercial restriction if it applies. If you want to combine material in a way that results in the creation of an adaptation (i.e. a “remix”), then you must pay attention to the particular license that applies to the content you want to combine.</p>
<p>The NoDerivatives licenses do not permit remixing except for private use (the pre-4.0 licenses do not permit remixing at all, except as allowed by exceptions and limitations to copyright). All the other CC licenses allow remixes, but may impose limitations or conditions on how the remix may be used. For example, if you create a remix with material licensed under a ShareAlike license, you need to make sure that all of the material contributed to the remix is licensed under the same license or <a href="http://creativecommons.org/compatiblelicenses">one that CC has named as compatible</a>, and you must <a href="Marking/Users" title="wikilink">properly credit all of the sources</a> with the <a href="Frequently_Asked_Questions#How_do_I_properly_attribute_material_offered_under_a_Creative_Commons_license.3F" title="wikilink">required attribution</a> and license information. Similarly, if you want to use a remix for <a href="Frequently_Asked_Questions#Does_my_use_violate_the_NonCommercial_clause_of_the_licenses.3F" title="wikilink">commercial purposes</a>, you cannot incorporate material released under one of the NonCommercial licenses.</p>
<p>The chart below shows which CC-licensed material can be remixed. To use the chart, find a license on the left column and on the top right row. If there is a check mark in the box where that row and column intersect, then the works can be remixed. If there is an “X” in the box, then the works may not be remixed unless an exception or limitation applies. See <a href="Frequently_Asked_Questions#If_I_derive_or_adapt_material_offered_under_a_Creative_Commons_license.2C_which_CC_license.28s.29_can_I_use.3F" title="wikilink">below for details on how remixes may be licensed</a>.</p>
<div class="figure">
...
<h3 id="if-i-derive-or-adapt-material-offered-under-a-creative-commons-license-which-cc-licenses-can-i-use">If I derive or adapt material offered under a Creative Commons license, which CC license(s) can I use?</h3>
<p>If you make <a href="Frequently_Asked_Questions#When_is_my_use_considered_an_adaptation.3F" title="wikilink">adaptations</a> of material under a CC license (i.e. &quot;remix&quot;), the original CC license always applies to the material you are adapting even once adapted. The license you may choose for your own contribution (called your &quot;adapter's license&quot;) depends on which license applies to the original material. Recipients of the adaptation must comply with both the CC license on the original and your adapter’s license.</p>
<p>: #### BY and BY-NC material</p>
...
<p>: #### BY-SA and BY-NC-SA material</p>
<p>In general, when remixing ShareAlike content, your adapter's license must be the same license as the license on the material you are adapting. All licenses after version 1.0 also allow you to license your contributions under a later version of the same license, and some also allow ported licenses. (See the <a href="License_Versions#Compatibility_mechanism_in_BY-SA_licenses" title="wikilink">license versions page</a> for details.) If you wish to adapt material under BY-SA or BY-NC-SA and release your contributions under a non-CC license, you should visit the <a href="http://creativecommons.org/compatiblelicenses">Compatibility page</a> to see which options are allowed.</p>
<p>: #### BY-ND and BY-NC-ND material</p>
<p>The BY-ND and BY-NC-ND licenses do not permit distribution of adaptations (also known as remixes or derivative works), and prohibits the creation of adaptations under the pre-4.0 versions of those licenses. Since you may not share remixes of these materials at all, there is no compatibility with other licenses. (Note that the ND licenses do allow you to reproduce the material in unmodified form together with other material in a collection, as indicated in the next FAQ.)</p>
<p>: #### Adapter's license chart</p>
<p>The chart below details the CC license(s) you may use as your adapter's license. When creating an adaptation of material under the license identified in the lefthand column, you may license your contributions to the adaptation under one of the licenses indicated on the top row if the corresponding box is green. CC does not recommend using a license if the corresponding box is yellow, although doing so is technically permitted by the terms of the license. If you do, you should take additional care to mark the adaptation as involving multiple copyrights under different terms so that downstream users are aware of their obligations to comply with the licenses from all rights holders. Dark gray boxes indicate those licenses that you may not use as your adapter's license.</p>
<table>
<tbody>
<tr class="odd">
<td align="left"><strong>Adapter's license chart</strong></td>
<td align="center">Adapter's license</td>
<td align="left"></td>
<td align="left"></td>
<td align="left"></td>
<td align="left"></td>
...
<tr class="odd">
<td align="left">Status of original work</td>
...
<tbody>
<tr class="odd">
<td align="left">Abbreviation Key</td>
</tr>
<tr class="even">
<td align="left">- BY = <a href="http://creativecommons.org/licenses/by/4.0/">Attribution only</a> - BY-ND = <a href="http://creativecommons.org/licenses/by-nd/4.0/">Attribution-NoDerivatives</a> - BY-NC-ND = <a href="http://creativecommons.org/licenses/by-nc-nd/4.0/">Attribution-NonCommercial- NoDerivatives</a> - BY-NC = <a href="http://creativecommons.org/licenses/by-nc/4.0/">Attribution-NonCommercial</a> - BY-NC-SA = <a href="http://creativecommons.org/licenses/by-nc-sa/4.0/">Attribution-NonCommercial- ShareAlike</a> - BY-SA = <a href="http://creativecommons.org/licenses/by-sa/4.0/">Attribution-ShareAlike</a> - PD = Dedicated to or marked as being in the public domain via one of our <a href="http://creativecommons.org/publicdomain">public domain tools</a>, or other public domain material; adaptations of materials in the public domain may be built upon and licensed by the creator under any license terms desired.</td>
</tr>
</tbody>
</table>
<p><span id="#If_I_create_a_collective_work_that_includes_a_work_offered_under_a_CC_license.2C_which_license.28s.29_may_I_choose_for_the_collection.3F"></span></p>
<h3 id="if-i-create-a-collection-that-includes-a-work-offered-under-a-cc-license-which-licenses-may-i-choose-for-the-collection">If I create a collection that includes a work offered under a CC license, which license(s) may I choose for the collection?</h3>
<p>All Creative Commons licenses (including the version 4.0 licenses) allow licensed material to be included in collections such as anthologies, encyclopedias, and broadcasts. You may choose a license for the collection, however this does not change the license applicable to the original material.</p>
<p>When you include CC-licensed content in a collection, you still must adhere to the license conditions governing your use of the material incorporated. For example, material under any of the Creative Commons NonCommercial licenses cannot be used <a href="Frequently_Asked_Questions#Does_my_use_violate_the_NonCommercial_clause_of_the_licenses.3F" title="wikilink">commercially</a>. The table below indicates what type of CC-licensed works you may incorporate into collections licensed for commercial and noncommercial uses.</p>
<table>
<tbody>
<tr class="odd">
<td align="left">Original Work</td>
<td align="left">Commercial Collection (BY, BY-SA, BY-ND)</td>
<td align="left">NonCommercial Collection (BY-NC, BY-NC-SA, BY-NC-ND)</td>
</tr>
<tr class="even">
<td align="left">PD</td>
<td align="left"> </td>
...
<h3 id="when-do-creative-commons-licenses-expire">When do Creative Commons licenses expire?</h3>
<p>Creative Commons licenses expire when the underlying copyright and similar rights expire.</p>
<p>Note that the relevant rights may expire at different times. For example, you may have a CC-licensed song where the rights in the musical arrangement expire before the rights in the lyrics. In this case, when the copyright in the music expires, you may use it <a href="Frequently_Asked_Questions#Do_I_always_have_to_comply_with_the_license_terms.3F_If_not.2C_what_are_the_exceptions.3F" title="wikilink">without being required to comply with the conditions of the CC license</a>; however, you must still comply with the license if you use the lyrics.</p>
<h3 id="what-happens-if-the-author-decides-to-revoke-the-cc-license-to-material-i-am-using">What happens if the author decides to revoke the CC license to material I am using?</h3>
...
<h3 id="how-can-i-lose-my-rights-under-a-creative-commons-license-if-that-happens-how-do-i-get-them-back">How can I lose my rights under a Creative Commons license? If that happens, how do I get them back?</h3>
...
<h3 id="how-do-creative-commons-licenses-and-public-domain-tools-work-technically">How do Creative Commons licenses and public domain tools work technically?</h3>
<p>The Creative Commons licenses have <a href="http://creativecommons.org/licenses/">three layers</a>, as does the <a href="http://creativecommons.org/about/cc0">CC0 public domain dedication</a>: the human-readable deed, the lawyer-readable legal code, and the machine-readable metadata. The <a href="http://creativecommons.org/publicdomain/mark/1.0/">Public Domain Mark</a> is not legally operative, and so has only two layers: the human-readable mark and machine-readable metadata.</p>
<p>When material is licensed using any of the CC licenses or tools, it is highly recommended that a <a href="http://creativecommons.org/about/downloads">CC button</a>, text, or other marker somehow accompany it. There are many possible modes for marking. For our licenses, people generally use the <a href="http://creativecommons.org/choose">CC license chooser</a> to generate HTML code that can be pasted into the webpage where the licensed material is published. CC0 and the Public Domain Mark have a separate <a href="http://creativecommons.org/publicdomain/">chooser</a>. Many platforms and web services such as <a href="http://www.flickr.com">Flickr</a> and <a href="Drupal" class="uri" title="wikilink">Drupal</a> support CC licensing directly, allowing you to select an appropriate license. The service then properly marks the work for you.</p>
<p>CC has published some best practices for <a href="Marking/Creators" title="wikilink">marking</a> your CC-licensed material, and recommends:</p>
<ul>
...
<li>Embedding <a href="Frequently_Asked_Questions#What_does_it_mean_that_Creative_Commons_licenses_are_.22machine_readable.22.3F" title="wikilink">machine-readable</a> metadata in the code of the license indicator or code of the licensed page.</li>
</ul>
<p><strong>See the <a href="Marking/Creators" title="wikilink">marking</a> page for more details.</strong></p>
<h3 id="what-does-it-mean-that-creative-commons-licenses-are-machine-readable">What does it mean that Creative Commons licenses are &quot;machine-readable&quot;?</h3>
<p>Creative Commons has <a href="CC%20REL" title="wikilink">specified CC REL</a> as a way to associate machine-readable licensing metadata with objects offered under CC licenses.</p>
...
<p>Machine-readable metadata based on well-accepted metadata standards creates a platform upon which new services and applications can be built. Software and services can detect CC licenses and the details of that license, as described by the metadata. For example, on many websites and search engines such as Google and Flickr, you can run filtered searches for works offered under specific CC licenses. In addition, CC license deeds can automatically create copy-and-paste attribution code so users may easily comply with the BY condition of the licenses. When you click on a CC license or <a href="http://creativecommons.org/about/downloads">button</a> from a page with license metadata, you get copy-and-paste attribution HTML within that license deed page. That HTML is based on available RDFa metadata in the original material.</p>
<p>All HTML provided by the <a href="http://creativecommons.org/choose">CC license chooser</a> is automatically annotated with <a href="metadata" class="uri" title="wikilink">metadata</a> in <a href="RDFa" class="uri" title="wikilink">RDFa</a> format.</p>
<p><span id="Why_did_Creative_Commons_choose_to_use_the_RDF_format_for_its_metadata.3F"></span></p>
<h3 id="what-is-rdfa">What is RDFa?</h3>
<p><a href="RDFa" class="uri" title="wikilink">RDFa</a> is a method for embedding structured data in a web page. For more information about RDFa, see the following resources:</p>
<ul>
<li><a href="http://www.w3.org/TR/xhtml-rdfa-primer/">RDFa Primer</a>: Bridging the Human and Data Webs</li>
<li><a href="http://rdfa.info/">RDFa.info</a></li>
<li><a href="http://rdfa.info/wiki">RDFa Wiki</a></li>
</ul>
<p><span id="How_can_I_use_Creative_Commons_metadata_in_my_program.3F"></span></p>
<h3 id="what-is-cc-rel-and-why-does-creative-commons-recommend-it">What is CC REL and why does Creative Commons recommend it?</h3>
<p><a href="http://wiki.creativecommons.org/CC_REL">Creative Commons Rights Expression Language</a> (CC REL) renders information about licenses and works machine-readable through standards that define the semantic web. Creative Commons wants to make it easy for creators and scientists to build upon the works of others when they choose; licensing your work for reuse and ﬁnding properly licensed works to reuse should be easy. CC recommends that you mark your licensed works with CC REL. The Creative Commons license chooser provides HTML annotated with CC REL, while the Creative Commons deeds recognize CC REL on web pages with works offered under a CC license, and use this metadata to enhance the deed for properly marked-up works, e.g., by providing copy and paste HTML that includes work attribution.</p>
<p>For more background information on CC REL, please refer to this <a href="http://wiki.creativecommons.org/images/d/d6/Ccrel-1.0.pdf">paper</a>.</p>
<h3 id="what-does-it-mean-for-a-search-engine-to-be-cc-enabled">What does it mean for a search engine to be CC-enabled?</h3>
<p>Some search engines (like <a href="http://www.google.com/advanced_search?hl=en">Google</a>) allow people to filter their search results by usage rights so that you can limit your search results according to the particular CC license you seek. For example, if you are looking for a photo to adapt, you can filter your search to return photos that have a CC license that permits creation of adaptations. You can generally find this search feature on the advanced search page of your selected search engine. You can also use <a href="http://search.creativecommons.org">CC Search</a>, which offers a convenient interface to search and a list of those content providers that support searches for content based on usage rights.</p>
...
<h3 id="how-do-i-give-users-of-my-site-the-option-to-use-cc-licensing-like-flickr-does">How do I give users of my site the option to use CC licensing like Flickr does?</h3>
<p>Creative Commons provides tools for integrating license selection with your site. You can find an overview at the Web Integration article on the <a href="http://wiki.creativecommons.org/Web_Integration">CC wiki</a>. The <a href="http://wiki.creativecommons.org/Partner_Interface">Partner Interface</a> is a good way to get started and will always have the most up-to-date license versions and translations. However, there is also an <a href="http://api.creativecommons.org/docs/">API</a> available if you want more control.</p>
<h3 id="how-can-i-change-or-remove-the-creative-commons-search-option-built-into-the-firefox-browser">How can I change or remove the Creative Commons search option built into the Firefox browser?</h3>
<p>Mozilla has included the Creative Commons search function in many versions of Firefox along with search options for Google, Amazon, and other popular sites. Please take a look at the <a href="http://wiki.creativecommons.org/Firefox_and_CC_Search">Firefox article on the CC wiki</a> for an explanation of how to change these features.</p>
...
<h3 id="is-creative-commons-involved-in-digital-rights-management-drm">Is Creative Commons involved in digital rights management (DRM)?</h3>
...
<h3 id="what-do-i-need-to-do-to-get-a-copyright">What do I need to do to get a copyright?</h3>
...
<p>In some jurisdictions, creators may be required to register with a national agency in order to enforce copyright in court. If you would like more information, please consult the <a href="http://www.wipo.int/treaties/en/ip/berne/trtdocs_wo001.html">Berne Convention</a> or <a href="http://www.wipo.int/clea/en/">your jurisdiction's copyright law</a>.</p>
...
<h3 id="what-is-an-adaptation">What is an adaptation?</h3>
...
<p>In order for an adaptation to be protected by copyright, most national laws require the creator of the adaptation to add original expression to the pre-existing work. However, there is no international standard for originality, and the definition differs depending on the jurisdiction. Civil law jurisdictions (such as <a href="http://www.wipo.int/clea/en/text_html.jsp?lang=EN&amp;id=1034">Germany</a> and <a href="http://www.legifrance.gouv.fr/html/codes_traduits/cpialtext.htm">France</a>) tend to require that the work contain an imprint of the adapter's personality. Common law jurisdictions (such as the <a href="http://www.copyright.gov/title17/92chap1.html#103">U.S.</a> or <a href="http://laws.justice.gc.ca/eng/C-42/index.html">Canada</a>), on the other hand, tend to have a lower threshold for originality, requiring only a minimal level of creativity and “independent conception.” Some countries approach originality completely differently. For example, <a href="http://www.wipo.int/clea/en/text_html.jsp?lang=EN&amp;id=514">Brazil's</a> copyright code protects all works of the mind that do not fall within the list of works that are expressly defined in the statue as “unprotected works.” Consult <a href="http://www.wipo.int/clea/en/">your jurisdiction's copyright law</a> for more information.</p>
...
<h3 id="what-are-moral-rights">What are moral rights?</h3>
...
<h3 id="what-are-collecting-societies">What are collecting societies?</h3>
<p><a href="http://wiki.creativecommons.org/Version_3#International_Harmonization_.E2.80.94_Collecting_Societies">Collecting societies</a> are copyright management organizations. Some examples of collecting societies include ASCAP and BMI (United States), BUMA/STEMRA (Netherlands), PRS (United Kingdom), and APRA (Australia). These societies license works on behalf of their owners and process royalty payments from parties using the copyrighted works.</p>
<p>CC offers additional information on <a href="#Can_I_use_a_Creative_Commons_license_if_I_am_a_member_of_a_collecting_society.3F" title="wikilink">how collecting societies might affect your rights and your ability to apply CC licenses to your work</a>. CC has several <a href="http://wiki.creativecommons.org/Collecting_Society_Projects">pilots</a> underway with collecting societies that have chosen to allow their members to use CC licenses on a limited basis.</p>
<p><span id="When_are_publicity_rights_relevant.3F"></span> <span id="What_are_publicity_and_privacy_rights.3F"></span></p>
<h3 id="what-are-publicity-personality-and-privacy-rights">What are publicity, personality, and privacy rights?</h3>
...
<p><a href="Frequently_Asked_Questions#How_are_publicity.2C_privacy.2C_and_personality_rights_affected_when_I_apply_a_CC_license.3F" title="wikilink">Creative Commons licenses have a limited effect on these rights</a> where the licensor holds them. Where the licensor has publicity, personality, or privacy rights that may affect your ability to use the material as the license intends, the licensor agrees to waive or not assert those rights. However, any such rights not held by the licensor are not affected and may still affect your desired use of a licensed work. If you have created a work or wish to use a work that might in some way implicate these rights, you may need to obtain permission from the individuals whose rights may be affected.</p>
<h2 id="data">Data</h2>
<p><noinclude> <em>This page supersedes <a href="Databases%20and%20Creative%20Commons" title="wikilink">Databases and Creative Commons</a>.</em></p>
<p>Much of the potential value of data is to society at large — more data has the potential to facilitate enhanced scientific collaboration and reproducibility, more efficient markets, increased government and corporate transparency, and overall to speed discovery and understanding of solutions to planetary and societal needs.</p>
<p>A big part of the potential value of data, in particular its society-wide value, is realized by use across organizational boundaries. How does this occur legally? Many sites give narrow permission to use data via terms of service. Much ad hoc data sharing also occurs among researchers. And increasingly, sharing of data is facilitated by distribution under standard, public legal tools used to manage copyright and similar restrictions that might otherwise limit dissemination or reuse of data, e.g. <a href="http://creativecommons.org/licenses/">CC licenses</a> or the <a href="CC0" class="uri" title="wikilink">CC0</a> public domain dedication.</p>
...
<p>Yes, <a href="Frequently_Asked_Questions#Can_I_apply_a_Creative_Commons_license_to_databases.3F" title="wikilink">CC licenses can be used to license databases</a>. The most recent version (4.0) may be used to license databases subject to copyright and, where applicable, sui generis database rights. Sui generis database rights prevent copying and reusing of <a href="Data#What_constitutes_a_.E2.80.9Csubstantial_portion.E2.80.9D_of_a_database.3F" title="wikilink">substantial parts</a> of a database (including frequent extraction of insubstantial parts). However unlike copyright, database rights protect the maker's investment, not originality.</p>
...
<p>In addition to our licenses, the <a href="CC0_FAQ" title="wikilink">CC0 Public Domain Dedication</a> may be used on databases to maximize reuse of databases. When applied, the effect is to waive all copyright and related rights in the database and its contents, placing it as close as possible into the worldwide public domain. In certain domains, such as science and government, there are important reasons to consider using CC0. Waiving copyright and related rights eliminates all uncertainty for potential users, encouraging maximal reuse and sharing of information.</p>
<h4 id="when-a-cc-license-is-applied-to-a-database-what-is-being-licensed">When a CC license is applied to a database, what is being licensed?</h4>
<p>The license terms and conditions apply to the database structure (its selection and arrangement, <a href="Data#Which_components_of_databases_are_protected_by_copyright.3F" title="wikilink">to the extent copyrightable</a>), its contents (if copyrightable), and in those instances where the database maker has <a href="Data#Which_components_of_a_database_are_protected_by_sui_generis_database_rights.3F" title="wikilink">sui generis database rights</a> then the rights that are granted those makers. Notwithstanding, licensors can choose to license some rather than all of the rights they have in a database. Creative Commons advises against this practice. However, if a licensor chooses to do so anyway, we strongly encourage licensors to clearly demarcate what is and is not licensed. See <a href="Data#How_do_I_apply_a_CC_legal_tool_to_a_database.3F" title="wikilink">below</a> for more information regarding how to provide clear notice of what is licensed.</p>
<h4 id="how-do-i-apply-a-cc-legal-tool-to-a-database">How do I apply a CC legal tool to a database?</h4>
<p>Before making a database available under a CC license, a database provider should first make sure she has all rights necessary to do so. Often, the database provider is not the original author of the database contents. If that is the case, the database provider should secure separate permission from the other author(s) before publishing the database under a CC legal tool. If a database maker decides to license the database without securing permission from the author(s) of the database contents, it should clearly indicate the material for which permission has not been secured and clearly mark the material as not being offered under the terms of the license. For more information, read our <a href="Considerations_for_licensors_and_licensees#Considerations_for_licensors" title="wikilink">pre-licensing</a> guidelines.</p>
<p>Database providers should also consider carefully what elements of the database she wants covered by the CC legal tool and identify those elements in a manner that reusers will see and understand. Please see our <a href="Marking_your_work_with_a_CC_license" title="wikilink">marking page</a> for more information on how to clearly distinguish unlicensed content.</p>
<h4 id="how-do-the-different-cc-license-elements-operate-for-a-cc-licensed-database">How do the different CC license elements operate for a CC-licensed database?</h4>
<p>Under version 4.0, if an NC license has been applied then any use of the licensed database or its contents <a href="Data#How_do_I_know_whether_a_particular_use_of_a_database_is_restricted_by_copyright.3F" title="wikilink">that is restricted by copyright law</a> or <a href="Data#How_do_I_know_whether_a_particular_use_of_a_database_is_restricted_by_sui_generis_database_rights.3F" title="wikilink">sui generis database rights</a> requires compliance with the <a href="Frequently_Asked_Questions#Does_my_use_violate_the_NonCommercial_clause_of_the_licenses.3F" title="wikilink">NC term</a>, even if the database is not publicly shared. The other license elements (BY, ND, and SA, as applicable) must be complied with only if your use is so restricted and public sharing is involved. Learn more about how to comply when <a href="Data#If_my_use_of_a_database_is_restricted_by_copyright.2C_how_do_I_comply_with_the_license.3F" title="wikilink">your use implicates copyright</a> and/or <a href="Data#If_my_use_of_a_database_is_restricted_by_sui_generis_database_rights.2C_how_do_I_comply_with_the_license.3F" title="wikilink">sui generis database rights</a>.</p>
<p>Prior CC license versions do not require compliance with the license restrictions or conditions when only sui generis database rights (and not copyright) are implicated. Please see below for more detail about <a href="Data#If_my_use_of_a_database_is_restricted_by_sui_generis_database_rights.2C_how_do_I_comply_with_the_license.3F" title="wikilink">how this works in the current</a> and <a href="Data#How_does_the_treatment_of_sui_generis_database_rights_vary_in_prior_versions_of_CC_licenses.3F" title="wikilink">prior versions</a> of the licenses.</p>
<h4 id="can-i-conduct-textdata-mining-on-a-cc-licensed-database">Can I conduct text/data mining on a CC-licensed database?</h4>
...
<p><strong><em>If and only if your particular use is one that would require permission</em></strong>, you should note the following:</p>
<ul>
<li><em>Permission:</em> All six of the 4.0 licenses allow for text and data mining by granting express permission to privately reproduce, extract, and reuse the contents of a licensed database and create adapted databases.</li>
<li><em>Commercial purposes:</em> If you are conducting text and data mining for <a href="Frequently_Asked_Questions#Does_my_use_violate_the_NonCommercial_clause_of_the_licenses.3F" title="wikilink">commercial purposes</a>, you should not mine NC-licensed databases or other material.</li>
<li><em>Outputs:</em> If you publicly share the results of your mining activity or the data you mined, you should attribute the rights holder. If what you publicly share qualifies as an adaptation of the licensed material, you should not mine ND-licensed material. If you share an adaptation of material under an SA license, you must apply the same license to the adaptation that results.</li>
</ul>
<p><a href="Frequently_Asked_Questions#Do_I_always_have_to_comply_with_the_license_terms.3F_If_not.2C_what_are_the_exceptions.3F" title="wikilink">If your use is not one that requires permission under the license</a>, you may conduct text and data mining activity without regard to the above considerations.</p>
<h4 id="how-does-the-treatment-of-sui-generis-database-rights-vary-in-prior-versions-of-cc-licenses">How does the treatment of sui generis database rights vary in prior versions of CC licenses?</h4>
<p>As explained <a href="Data#Can_databases_be_released_under_CC_licenses.3F" title="wikilink">above</a>, the current version of the CC license suite (4.0) licenses sui generis database rights in addition to copyright and other closely related rights. Past versions of CC licenses operate differently with respect to sui generis database rights.</p>
...
<p>While this result is the same across all CC version 3.0 licenses, the reason for this outcome varies. In the 3.0 licenses ported to the laws of EU jurisdictions, the scope of the licenses expressly cover databases subject to copyright and/or sui generis database rights. However, the conditions of the license are explicitly waived when use of the licensed work only involves the exercise of database rights.</p>
...
<p>More information on the underlying 3.0 policy decision the treatment of sui generis database rights those licenses can be found <a href="Media:V3_Database_Rights.pdf" title="wikilink">on our wiki (.pdf)</a>.</p>
<h4 id="what-is-the-difference-between-the-open-data-commons-licenses-and-the-cc-4.0-licenses">What is the difference between the Open Data Commons licenses and the CC 4.0 licenses?</h4>
<p>The <a href="http://opendatacommons.org/licenses/odbl/1.0/">Open Database License (ODbL)</a> and the <a href="http://opendatacommons.org/licenses/by/1.0/">Open Data Commons Attribution License (ODC-BY)</a> are licenses designed specifically for use on databases and not on other types of material. There are many differences between those licenses and CC licenses, but the most important to be aware of relate to license scope and operation. The ODC licenses apply only to sui generis database rights and any copyright in the database structure, they do not apply to the individual contents of the database. The latest version of the CC licenses on the other hand apply to sui generis database rights and all copyright and neighboring rights in the database structure as well as the contents. (See <a href="Data#How_does_the_treatment_of_sui_generis_database_rights_vary_in_prior_versions_of_CC_licenses.3F" title="wikilink">above</a> for more detail about how past versions of CC licenses vary with respect to sui generis database rights.)</p>
<p>Another important difference is that ODC licenses may create contractual obligations even in jurisdictions where database rights would not otherwise exist and but for the license permission would not be necessary. CC has crafted its licenses to ensure that they <a href="Frequently_Asked_Questions#How_do_CC_licenses_operate.3F" title="wikilink">never impose obligations where permission is not otherwise required</a> to use the licensed material.</p>
<h3 id="frequently-asked-questions-about-data-generally">Frequently asked questions about data, generally</h3>
<h4 id="which-components-of-databases-are-protected-by-copyright">Which components of databases are protected by copyright?</h4>
<p>With databases, there are likely four components to consider: (1) the database model or structure, (2) the data entry and output sheet, (3) field names, and (4) the data or other content.</p>
<p>The <strong>database model</strong> refers to how a database is structured and organized, including database tables and table indexes. The selection, coordination, and arrangement of the database is subject to copyright if it is sufficiently original. The originality threshold is fairly low in many jurisdictions. For example, while courts in the United States have held that an alphabetical telephone directory was insufficiently original to merit copyright protection, an organized directory of Chinese-American businesses in a particular area did.<a href="#fn1" class="footnoteRef" id="fnref1"><sup>1</sup></a> These determinations are very fact-specific (no pun intended) and vary by jurisdiction.</p>
<p>The <strong>data entry and output sheets</strong> contain questions, and the answers to these questions are stored in a database. For example, a web page asking a scientist to enter a gene’s name, its pathway information, and its ontology would constitute a data entry sheet. The format and layout of these sheets are protected by copyright according to the same standard of originality used to determine if the database model is copyrightable.</p>
<p><strong>Field names</strong> describe the contents or data. For example, “address” might be the name of the field for street address information. These are less likely to be protected by copyright because they often lack sufficient originality.</p>
<p>The <strong>data</strong> or other contents contained in the database are subject to copyright if they are sufficiently creative. Original poems contained in a database would be protected by copyright, but purely factual data (such as gene names or city populations) would not. Facts are not subject to copyright, nor are the ideas underlying copyrighted content.</p>
<h4 id="how-do-i-know-whether-a-particular-use-of-a-database-is-restricted-by-copyright">How do I know whether a particular use of a database is restricted by copyright?</h4>
<p>When the database structure or its contents is subject to copyright, reproducing, distributing, or modifying the database will often be restricted by copyright law. However, it is important to note that some uses of a copyrighted database will not be restricted by copyright. It may be possible, for example, to rearrange or modify the uncopyrightable data in a way that does not implicate the copyright in the database structure. For example, while (as noted above) a court in the United States held that a directory of Chinese-American businesses was restricted by copyright, the same court went on to hold that a directory that duplicated hundreds of its listings was not infringing because the listings were categorized and arranged in a sufficiently dissimilar way. In those situations, compliance with the license conditions is not required unless the database contents are themselves restricted by copyright.</p>
<p>Similarly, even where database contents are subject to copyright and published under a CC license, use of the facts and ideas embedded within the contents will not require attribution (or compliance with other applicable license conditions), unless doing so implicates copyright in the database structure as explained above. This <a href="Frequently_Asked_Questions#How_do_CC_licenses_operate.3F" title="wikilink">important limitation of all CC licenses</a> is highlighted on the license deeds in the Notice section, where we emphasize that compliance with the license is not required for elements of the material in the public domain.</p>
<h4 id="if-my-use-of-a-database-is-restricted-by-copyright-how-do-i-comply-with-the-license">If my use of a database is restricted by copyright, how do I comply with the license?</h4>
<p>All CC licenses require that you attribute the licensor when your use involves public sharing. Your other obligations depend on the particular CC license applied to the database. If it is a NC license, any regulated use must be limited to <a href="Frequently_Asked_Questions#Does_my_use_violate_the_NonCommercial_clause_of_the_licenses.3F" title="wikilink">noncommercial purposes</a> only. If a ND is applied, you may produce an adapted database but cannot share it publicly. If it is a ShareAlike (SA) license, you must apply the same or a <a href="FAQ#If_I_derive_or_adapt_material_offered_under_a_Creative_Commons_license.2C_which_CC_license.28s.29_can_I_use.3F" title="wikilink">compatible license</a> to any adaptation of the database you share publicly.</p>
<p><span id="What_are_sui_generis_database_rights.3F"></span></p>
<h4 id="which-components-of-a-database-are-protected-by-sui-generis-database-rights">Which components of a database are protected by sui generis database rights?</h4>
<p>In contrast to copyright, sui generis database rights are designed to protect a maker's substantial investment in a database. In particular, the right prevents the unauthorized extraction and reuse of a <a href="Data#What_constitutes_a_.E2.80.9Csubstantial_portion.E2.80.9D_of_a_database.3F" title="wikilink">substantial portion</a> of the contents.</p>
<h4 id="how-do-i-know-whether-a-particular-use-of-a-database-is-restricted-by-sui-generis-database-rights">How do I know whether a particular use of a database is restricted by sui generis database rights?</h4>
<p>When a database is subject to sui generis database rights, extracting and reusing a <a href="Data#What_constitutes_a_.E2.80.9Csubstantial_portion.E2.80.9D_of_a_database.3F" title="wikilink">substantial portion</a> of the database contents is prohibited absent some express exception.</p>
<p><strong>It is important to remember that sui generis database rights exist in only a few countries outside the <a href="http://en.wikipedia.org/wiki/Database_Directive#Implementation">European Union</a>, such as Korea and Mexico. Generally, if you are using a CC-licensed database in a location where those rights do not exist, you do not have to comply with license restrictions or conditions unless copyright (or some other licensed right) is implicated.</strong></p>
<p>Note that if you are using a database in a jurisdiction where you must respect database rights, and you receive a CC-licensed work from someone located in a jurisdiction without database rights, you should determine whether database rights exist and have been licensed. If so, you need to properly mark and attribute as the license requires, since the person from whom you received the database may not have been required to keep that information. If you are using a licensed database and you do not have to comply with the license terms because such rights do not exist in your jurisdiction, we recommend that you retain this information where possible. Doing so assists downstream reusers who are required to provide it when they share further.</p>
<h4 id="what-constitutes-a-substantial-portion-of-a-database">What constitutes a “substantial portion” of a database?</h4>
<p>There is no bright line test for what constitutes a “substantial portion”. The answer will depend on the law in the relevant jurisdiction. Note that what constitutes a substantial portion is determined both quantitatively and qualitatively. Also, using several insubstantial portions can add up to a substantial portion.</p>
<p><span id="How_(if_at_all)_are_sui_generis_database_rights_addressed_in_CC_licenses.3F&#39;"></span></p>
...
<p>If the database is released under the current version (4.0) of CC licenses, you must attribute the licensor if you share a <a href="Data#What_constitutes_a_.E2.80.9Csubstantial_portion.E2.80.9D_of_a_database.3F" title="wikilink">substantial portion</a> of the database contents. The other requirements depend on the particular license applied to the database. Under the NC licenses, you may not extract and reuse a substantial portion of the database contents for <a href="Frequently_Asked_Questions#Does_my_use_violate_the_NonCommercial_clause_of_the_licenses.3F" title="wikilink">commercial purposes</a>. The ND licenses prohibit you from including a substantial portion of the database contents in another publicly shared database in which you have sui generis database rights of your own. And finally, the SA licenses require you to apply the same or a <a href="FAQ#If_I_derive_or_adapt_material_offered_under_a_Creative_Commons_license.2C_which_CC_license.28s.29_can_I_use.3F" title="wikilink">compatible license</a> to any database you share publicly and in which you include a substantial portion of the licensed database contents. Note that this does <strong>not</strong> require you to ShareAlike any copyright or other rights you have in the individual contents of the database.</p>
